...
public class ECommerceLongPress05 extends BaseECommerceApp {
    ...
    public void positiveTest() throws MalformedURLException, InterruptedException {
        ...
        //Fiyat(sepetteki urunlerin fiyat toplamını dogrulama)
        ...
        /*
        Substring ile bastaki dolar isaretinden kurtulduk daha sonra
        strıng olan fiyat tutarını double parse ıle doubleye cevirdik ve ıkı urunun fiayıtnı topladık
        ınspecter uzerınden actual fiyat locate edip aynı ıslemleri ona da uyguladık sonra assert yaparak dogruladık
         */
        Double amount=0.0;
        ...
        //term of conditions gormek icin long press yapilmali
